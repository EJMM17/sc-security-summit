      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                href="https://www.linkedin.com/company/113157048/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-blue-600 hover:text-white transition-colors"
              >
                <LinkedInIcon />
              </a>
              <a
                href="https://www.instagram.com/supply_chain_security_summit/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61589352448514"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-blue-600 hover:text-white transition-colors"
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-slate-500">
            Diseñado por <span className="text-slate-400">Null Studio</span>
          </p>
