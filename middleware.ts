...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "connect-src 'self' https://vitals.vercel-insights.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://www.googletagmanager.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://*.g.doubleclick.net https://stats.g.doubleclick.net https://www.facebook.com https://px.ads.linkedin.com",
    "form-action 'self'",
    "base-uri 'self'",
