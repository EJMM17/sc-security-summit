  ...
  en: [
    {
      ...
      features: [
        ...
        "Participation in industry expert panels",
        "Access badge",
        "Printed materials and participant kit",
        "Official certificate of participation and DC-3",
        "Business Hub access and networking spaces",
      ],
    },
    {
      id: "vip",
      ...
      features: [
        "Keynote conferences and specialized sessions",
        "Industry expert panels",
        "Access badge, access wristband, and official registration",
        "Premium welcome kit",
        "Official certificate of participation and DC-3 format",
        "Business Hub access for networking and business development",
        "Priority seating at main sessions",
        "Priority access in lines, Q&A, and Hub activities",
        "Downloadable materials, resources, and work templates",
        "Specialized workshop included",
    ...
    },
    {
      ...
      features: [
        ...
        "Certificate of participation available at additional cost",
      ],
    },
  ],
} as const;
...
export const FAQ_ITEMS_EN = [
  ...
  },
  {
    ...
    answer:
      "Contact us at Contacto@LanzLogistics.com or +1 (956) 515-8070. We will send the sponsorship kit with participation levels (Platinum, Gold, Silver, and Strategic Allied Provider) and the benefits for each tier.",
  },
  {
